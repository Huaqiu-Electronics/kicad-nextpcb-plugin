...
from nextPCB_plugin.kicad_nextpcb_new.nextpcb_tools_view.ui_assigned_part_panel.assigned_part_view import (
    AssignedPartView,
)
from nextPCB_plugin.kicad_nextpcb_new.nextpcb_tools_view.foot_print_list import FootPrintList
from nextPCB_plugin.kicad_nextpcb_new.nextpcb_tools_view.ui_match_part_panel.match_part_view import (
    MatchPartView,
)
